	...
	return &openapipb.OpenAPI{
				...
				Post: &openapipb.OpenAPIPathDocs{
						...
						Content: &openapipb.PathRequestBodyContent{
							ApplicationJson: &openapipb.ApplicationContent{
								Schema: &openapipb.Schema{
									Ref: "#/components/schemas/github.com.vine-io.raft.examples.proto.CreateProductRequest",
								},
							},
						},
					},
					Responses: map[string]*openapipb.PathResponse{
						"200": &openapipb.PathResponse{
							...
							Content: &openapipb.PathRequestBodyContent{
								ApplicationJson: &openapipb.ApplicationContent{
									Schema: &openapipb.Schema{Ref: "#/components/schemas/github.com.vine-io.raft.examples.proto.CreateProductResponse"},
								},
							},
						},
					},
				...
				Get: &openapipb.OpenAPIPathDocs{
					...
					Responses: map[string]*openapipb.PathResponse{
						"200": &openapipb.PathResponse{
							...
							Content: &openapipb.PathRequestBodyContent{
								ApplicationJson: &openapipb.ApplicationContent{
									Schema: &openapipb.Schema{Ref: "#/components/schemas/github.com.vine-io.raft.examples.proto.GetProductResponse"},
								},
							},
						},
					},
		...
		Components: &openapipb.OpenAPIComponents{
			...
			Schemas: map[string]*openapipb.Model{
				"github.com.vine-io.raft.examples.proto.CreateProductRequest": &openapipb.Model{
					Type: "object",
				...
				"github.com.vine-io.raft.examples.proto.CreateProductResponse": &openapipb.Model{
					Type: "object",
					Properties: map[string]*openapipb.Schema{
						"product": &openapipb.Schema{
							Type: "object",
							Ref:  "#/components/schemas/github.com.vine-io.raft.examples.proto.Product",
						},
					},
				},
				"github.com.vine-io.raft.examples.proto.GetProductRequest": &openapipb.Model{
					Type: "object",
					Properties: map[string]*openapipb.Schema{
						"id": &openapipb.Schema{
							Type: "string",
				...
				"github.com.vine-io.raft.examples.proto.GetProductResponse": &openapipb.Model{
					Type: "object",
					Properties: map[string]*openapipb.Schema{
						"product": &openapipb.Schema{
							Type: "object",
				...
				"github.com.vine-io.raft.examples.proto.Product": &openapipb.Model{
					Type: "object",
					Properties: map[string]*openapipb.Schema{
